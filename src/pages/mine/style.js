...
background: #f7f7f7;height: 100%;overflow-y:auto ;
...
.user{display: flex;font-size: 35px;font-weight:bold;align-items: center;color: #333;margin-top: 1.3rem;}
.allbill{height: 1.2rem;display: flex;align-items: center;justify-content: space-between;padding: 0 .2rem;
    ...
    .navbar{height: 1.6rem;display: flex;justify-content: space-around;align-items: center;font-size: 28px;margin-top: 2px;background: #fff;margin-bottom: .3rem;color: #999; 
        i{font-size: 33px;}}
.listsign{height: 1.2rem;display: flex;align-items: center;justify-content: space-between;padding: 0 .2rem;
